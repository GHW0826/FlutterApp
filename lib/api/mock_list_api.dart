  ...
  switch (themeId) {
    ...
    case 'bond':
      return [
        const ListItemModel(
          id: 'bd1',
          title: 'Korean Treasury 3Y',
          subtitle: 'KR3YT',
        ),
        const ListItemModel(
          id: 'bd2',
          title: 'Korean Treasury 10Y',
          subtitle: 'KR10YT',
        ),
        const ListItemModel(
          id: 'bd3',
...
/// Theme list for Reference master registration
/// (vendor, counterparty, currency, exchange, issuer).
Future<List<ListItemModel>> fetchReferenceMasterList(String themeId) async {
    ...
    case 'vendor':
      return [
        ...
        const ListItemModel(
          id: 'ven_2',
          title: 'Refinitiv',
          subtitle: 'RFT | Inactive',
        ),
        const ListItemModel(
          id: 'ven_3',
          title: 'MarketData Lab',
          subtitle: 'MDL | Suspended',
        ),
        const ListItemModel(
          id: 'ven_4',
          title: 'Legacy Feed',
          subtitle: 'LGY | Deprecated',
        ),
      ];
    case 'counterparty':
      return [
    ...
    case 'issuer':
      return [
        const ListItemModel(
          ...
          subtitle: 'KRGOV | Active',
        ),
        const ListItemModel(
          id: 'is_ustsy',
          title: 'US Treasury',
          subtitle: 'USTSY | Active',
        ),
      ];
    default:
      return [];
...
Future<List<ListItemModel>> fetchJobScheduleList() async {
  ...
  return [
    const ListItemModel(
      id: 'js1',
      title: 'Daily Position Sync',
      subtitle: '08:30',
    ),
    const ListItemModel(
      id: 'js2',
      title: 'EOD Pricing Batch',
      subtitle: '17:10',
    ),
    const ListItemModel(
      id: 'js3',
