...
import 'weekend_profile_day_list_screen.dart';
import 'weekend_profile_list_screen.dart';
          ...
          children: [
            ...
            _TopicButton(
              ...
              onTap: () {
                Navigator.of(context).push(
                  MaterialPageRoute<void>(
                    builder: (_) => const WeekendProfileListScreen(),
                  ),
                );
              },
            ),
            const SizedBox(height: 12),
            _TopicButton(
              label: 'Weekend Profile Day',
              icon: Icons.view_week_outlined,
              onTap: () {
                Navigator.of(context).push(
                  MaterialPageRoute<void>(
                    builder: (_) => const WeekendProfileDayListScreen(),
                  ),
                );
              },
            ),
