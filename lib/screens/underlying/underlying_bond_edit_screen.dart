...
class UnderlyingBondEditScreen extends StatefulWidget {
  ...
  @override
  State<UnderlyingBondEditScreen> createState() =>
      _UnderlyingBondEditScreenState();
}
...
class _UnderlyingBondEditScreenState extends State<UnderlyingBondEditScreen> {
  ...
  void initState() {
    ...
    _marketDataCode = d?.marketDataCode.isNotEmpty == true
        ? d!.marketDataCode
        : null;
  ...
  Future<void> _onMarketDataChanged(String? value) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('통신오류')));
    } finally {
  ...
  String _marketDataLabel(String? code) {
    ...
    final item = widget.marketDataOptions.where((e) {
      final itemCode = (e.subtitle?.trim().isNotEmpty ?? false)
          ? e.subtitle!.trim()
          : e.id;
              ...
              ListView(
                ...
                children: [
                  TextFormField(
                    ...
                    validator: (v) =>
                        (v == null || v.trim().isEmpty) ? 'Name 필수' : null,
                  ),
